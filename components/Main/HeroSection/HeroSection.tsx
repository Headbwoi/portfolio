...
const HeroSection = () => {
  return (
    <div className="w-full pt-[10%] sm:pt-[25%] lg:pt-0 flex items-center justify-start sm:justify-center lg:justify-start flex-col min-h-[30rem] md:min-h-[40rem] xl:min-h-[40rem]">
